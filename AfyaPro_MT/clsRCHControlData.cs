...
{
    public class clsRCHControlData : MarshalByRefObject
    {

        #region declaration

        private static String pClassName = "AfyaPro_MT.clsRCHControlData";
        ...
        #region Add
        public AfyaPro_Types.clsResult Add(string mDescription, int mCategory)
        {
            int mGenerateCode = -1; // this is for no AUTOCODE

            //descpription, quantityentry, category
            ...
            try
            {
                ...
                //execute statements
                mCommand.CommandText = "insert into rch_birthcomplications(description,category) values('"
                + mDescription + "','"
                + mCategory + "')";
        ...
        #region Edit
        public AfyaPro_Types.clsResult Edit(String mDescription, string mUserId)
        {
            ...
            try
            {
                mCommand.CommandText = "select * from rch_birthcomplications where description='" + mDescription + "'";
            ...
            try
            {
                ...
                mCommand.CommandText = "update rch_birthcomplications set description = '"
                + mDescription.Trim() + "' where description='" + mDescription + "'";
                mCommand.ExecuteNonQuery();
        ...
        public AfyaPro_Types.clsResult Delete(String mDescription, string mUserId)
        {
            ...
            try
            {
                ...
                mCommand.CommandText = "delete from rch_birthcomplications where description='" + mDescription + "'";
                mCommand.ExecuteNonQuery();
