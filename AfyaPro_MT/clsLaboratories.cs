...
{
    public class clsLaboratories : MarshalByRefObject
    {

        #region declaration

        private static String pClassName = "AfyaPro_MT.clsLaboratories";
        ...
        public DataTable View(String mFilter, String mOrder, string mLanguageName, string mGridName)
        {
            ...
            try
            {
                string mCommandText = "select * from facilitylaboratories";
                ...
                DataTable mDataTable = new DataTable("facilitylaboratories");
        ...
        public AfyaPro_Types.clsResult Add(Int16 mGenerateCode, String mCode, String mDescription, string mUserId)
        {
            ...
            if (mGenerateCode == 1)
            {
                ...
                mObjCode = objAutoCodes.Next_Code(
                    Convert.ToInt16(AfyaPro_Types.clsEnums.SystemGeneratedCodes.laboritoryno), "facilitylaboratories", "code");
            ...
            try
            {
                mCommand.CommandText = "select * from facilitylaboratories where code='"
                + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == true)
                {
                    mResult.Exe_Result = 0;
                    mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.LAB_LaboratoryCodeIsInUse.ToString();
                    return mResult;
                }
            }
            ...
            try
            {
                ...
                mCommand.CommandText = clsGlobal.Get_InsertStatement("facilitylaboratories", mDataFields);
        ...
        public AfyaPro_Types.clsResult Edit(String mCode, String mDescription, string mUserId)
        {
            ...
            try
            {
                mCommand.CommandText = "select * from facilitylaboratories where code='" + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == false)
                {
                    mResult.Exe_Result = 0;
                    mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.LAB_LaboratoryCodeDoesNotExist.ToString();
                    return mResult;
                }
            }
            catch (OdbcException ex)
            ...
            try
            {
                ...
                mCommand.CommandText = clsGlobal.Get_UpdateStatement("facilitylaboratories", mDataFields, "code='" + mCode.Trim() + "'");
                mCommand.ExecuteNonQuery();
        ...
        public AfyaPro_Types.clsResult Delete(String mCode, string mUserId)
        {
            ...
            try
            {
                mCommand.CommandText = "select * from labpatienttestst where laboratorycode='" + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == true)
                {
                    mResult.Exe_Result = 0;
            ...
            try
            {
                ...
                mCommand.CommandText = clsGlobal.Get_DeleteStatement("facilitylaboratories", "code='" + mCode.Trim() + "'");
                mCommand.ExecuteNonQuery();
