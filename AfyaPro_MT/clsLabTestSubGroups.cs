...
{
    public class clsLabTestSubGroups : MarshalByRefObject
    {
        #region declaration

        private static String pClassName = "AfyaPro_MT.clsLabTestSubGroups";
        ...
        public DataTable View(String mFilter, String mOrder, string mLanguageName, string mGridName)
        {
            ...
            try
            {
                string mCommandText = "select * from labtestsubgroups";
                ...
                DataTable mDataTable = new DataTable("labtestsubgroups");
                ...
                DataTable mDtGroups = new DataTable("labtestgroups");
        ...
        public AfyaPro_Types.clsResult Add(Int16 mGenerateCode, String mCode, String mDescription, String mGroupCode)
        {
            ...
            if (mGenerateCode == 1)
            {
                ...
                mObjCode = objAutoCodes.Next_Code(
                    Convert.ToInt16(AfyaPro_Types.clsEnums.SystemGeneratedCodes.labtestsubgroupcode), "labtestsubgroups", "code");
            ...
            try
            {
                mCommand.CommandText = "select * from labtestsubgroups where code='"
                + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == true)
                {
                    mResult.Exe_Result = 0;
                    mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.LAB_LabTestSubGroupCodeIsInUse.ToString();
                    return mResult;
                }
            }
            ...
            try
            {
                ...
                //execute statements
                mCommand.CommandText = "insert into labtestsubgroups(code,description,groupcode) values('"
        ...
        public AfyaPro_Types.clsResult Edit(String mCode, String mDescription)
        {
            ...
            try
            {
                mCommand.CommandText = "select * from labtestsubgroups where code='" + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == false)
                {
                    mResult.Exe_Result = 0;
                    mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.LAB_LabTestSubGroupCodeDoesNotExist.ToString();
                    return mResult;
                }
            }
            catch (OdbcException ex)
            ...
            try
            {
                ...
                mCommand.CommandText = "update labtestsubgroups set description = '"
        ...
        public AfyaPro_Types.clsResult Delete(String mCode)
        {
            ...
            try
            {
                mCommand.CommandText = "select * from labtests where subgroupcode='" + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == true)
                {
                    mResult.Exe_Result = 0;
            ...
            try
            {
                ...
                mCommand.CommandText = "delete from labtestsubgroups where code='" + mCode.Trim() + "'";
                mCommand.ExecuteNonQuery();
