...
{
    public class clsRCHBirthMethods : MarshalByRefObject
    {
        #region declaration

        private static String pClassName = "AfyaPro_MT.clsRCHBirthMethods";
        ...
        public DataTable View(String mFilter, String mOrder, string mLanguageName, string mGridName)
        {
            ...
            try
            {
                string mCommandText = "select * from rch_birthmethods";
                ...
                DataTable mDataTable = new DataTable("rch_birthmethods");
        ...
        #region View_BirthMethods
        public DataTable View_BirthMethods()
        {
            String mFunctionName = "View";
            ...
            try
            {
                string mCommandText = "select code, description from rch_birthmethods";
            ...
            string mUserId)
        {
            ...
            bool mGranted = clsGlobal.GrantDeny_FunctionAccess(mCommand,
                AfyaPro_Types.clsSystemFunctions.FunctionKeys.rchbirthmethods_add.ToString(), mUserId);
            if (mGranted == false)
            {
            ...
            try
            {
                mCommand.CommandText = "select * from rch_birthmethods where code='"
                + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == true)
                {
                    mResult.Exe_Result = 0;
                    mResult.Exe_Message = "Code is already in use by another method";
                    return mResult;
                }
            }
            ...
            try
            {
                ...
                mCommand.CommandText = clsGlobal.Get_InsertStatement("rch_birthmethods", mDataFields);
            ...
            string mUserId)
        {
            ...
            #region check security for this function
            bool mGranted = clsGlobal.GrantDeny_FunctionAccess(mCommand,
                AfyaPro_Types.clsSystemFunctions.FunctionKeys.rchbirthmethods_edit.ToString(), mUserId);
            if (mGranted == false)
            {
                mResult.Exe_Result = 0;
                mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.GRL_AccessDeniedToSystemFunction.ToString();
            ...
            try
            {
                mCommand.CommandText = "select * from rch_birthmethods where code='" + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == false)
                {
                    mResult.Exe_Result = 0;
                    mResult.Exe_Message = "Method code does not exist";
                    return mResult;
                }
            }
            catch (OdbcException ex)
            ...
            try
            {
                ...
                mCommand.CommandText = clsGlobal.Get_UpdateStatement("rch_birthmethods", mDataFields, "code='" + mCode.Trim() + "'");
                mCommand.ExecuteNonQuery();
        ...
        public AfyaPro_Types.clsResult Delete(String mCode, string mUserId)
        {
            ...
            #region check security for this function
            bool mGranted = clsGlobal.GrantDeny_FunctionAccess(mCommand,
                AfyaPro_Types.clsSystemFunctions.FunctionKeys.rchbirthmethods_delete.ToString(), mUserId);
            if (mGranted == false)
            {
                mResult.Exe_Result = 0;
                mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.GRL_AccessDeniedToSystemFunction.ToString();
            ...
            try
            {
                ...
                //rch_birthmethods
                mCommand.CommandText = clsGlobal.Get_DeleteStatement("rch_birthmethods", "code='" + mCode.Trim() + "'");
                mCommand.ExecuteNonQuery();
