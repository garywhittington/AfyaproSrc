...
{
    public class clsRCHFPlanMethods : MarshalByRefObject
    {
        #region declaration

        private static String pClassName = "AfyaPro_MT.clsRCHFPlanMethods";
        ...
        public DataTable View(String mFilter, String mOrder, string mLanguageName, string mGridName)
        {
            ...
            try
            {
                string mCommandText = "select * from rch_fplanmethods";
                ...
                DataTable mDataTable = new DataTable("rch_fplanmethods");
            ...
            string mUserId)
        {
            ...
            bool mGranted = clsGlobal.GrantDeny_FunctionAccess(mCommand,
                AfyaPro_Types.clsSystemFunctions.FunctionKeys.rchfplanmethods_add.ToString(), mUserId);
            if (mGranted == false)
            {
            ...
            try
            {
                mCommand.CommandText = "select * from rch_fplanmethods where code='"
                + mCode.Trim() + "'";
            ...
            try
            {
                ...
                mCommand.CommandText = clsGlobal.Get_InsertStatement("rch_fplanmethods", mDataFields);
            ...
            string mUserId)
        {
            ...
            #region check security for this function
            bool mGranted = clsGlobal.GrantDeny_FunctionAccess(mCommand,
                AfyaPro_Types.clsSystemFunctions.FunctionKeys.rchfplanmethods_edit.ToString(), mUserId);
            if (mGranted == false)
            {
                mResult.Exe_Result = 0;
                mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.GRL_AccessDeniedToSystemFunction.ToString();
            ...
            try
            {
                mCommand.CommandText = "select * from rch_fplanmethods where code='" + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
            ...
            try
            {
                ...
                mCommand.CommandText = clsGlobal.Get_UpdateStatement("rch_fplanmethods", mDataFields, "code='" + mCode.Trim() + "'");
                mCommand.ExecuteNonQuery();
        ...
        public AfyaPro_Types.clsResult Delete(String mCode, string mUserId)
        {
            ...
            #region check security for this function
            bool mGranted = clsGlobal.GrantDeny_FunctionAccess(mCommand,
                AfyaPro_Types.clsSystemFunctions.FunctionKeys.rchfplanmethods_delete.ToString(), mUserId);
            if (mGranted == false)
            {
                mResult.Exe_Result = 0;
                mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.GRL_AccessDeniedToSystemFunction.ToString();
            ...
            try
            {
                ...
                //rch_fplanmethods
                mCommand.CommandText = clsGlobal.Get_DeleteStatement("rch_fplanmethods", "code='" + mCode.Trim() + "'");
                mCommand.ExecuteNonQuery();
