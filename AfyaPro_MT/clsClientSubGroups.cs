...
{
    public class clsClientSubGroups : MarshalByRefObject
    {
        #region declaration

        private static String pClassName = "AfyaPro_MT.clsClientSubGroups";
        ...
        public DataTable View(String mFilter, String mOrder, string mLanguageName, string mGridName)
        {
            ...
            try
            {
                string mCommandText = "select * from facilitycorporatesubgroups";
                ...
                DataTable mDataTable = new DataTable("facilitycorporatesubgroups");
        ...
        #region Add
        public AfyaPro_Types.clsResult Add(Int16 mGenerateCode, String mCode, String mDescription, String mGroupCode)
        {
            ...
            if (mGenerateCode == 1)
            {
                ...
                mObjCode = objAutoCodes.Next_Code(
                    Convert.ToInt16(AfyaPro_Types.clsEnums.SystemGeneratedCodes.clientsubgroupcode), "facilitycorporatesubgroups", "code");
            ...
            try
            {
                mCommand.CommandText = "select * from facilitycorporatesubgroups where code='"
                + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == true)
                {
                    mResult.Exe_Result = 0;
                    mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.CUS_CustomerSubGroupCodeIsInUse.ToString();
                    return mResult;
                }
            }
            ...
            try
            {
                ...
                //execute statements
                mCommand.CommandText = "insert into facilitycorporatesubgroups(code,description,groupcode) values('"
                ...
                if (mGenerateCode == 1)
                {
                    ...
                    + Convert.ToInt16(AfyaPro_Types.clsEnums.SystemGeneratedCodes.clientsubgroupcode);
                    mCommand.ExecuteNonQuery();
                }
        ...
        public AfyaPro_Types.clsResult Edit(String mCode, String mDescription)
        {
            ...
            try
            {
                mCommand.CommandText = "select * from facilitycorporatesubgroups where code='" + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == false)
                {
                    mResult.Exe_Result = 0;
                    mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.CUS_CustomerSubGroupCodeDoesNotExist.ToString();
                    return mResult;
                }
            }
            catch (OdbcException ex)
            ...
            try
            {
                ...
                mCommand.CommandText = "update facilitycorporatesubgroups set description = '"
        ...
        #region Delete
        public AfyaPro_Types.clsResult Delete(String mCode)
        {
            ...
            #region check if is in use facilitycorporatemembers
            try
            {
                mCommand.CommandText = "select * from facilitycorporatemembers where billingsubgroupcode='" + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == true)
                {
                    mResult.Exe_Result = 0;
            ...
            try
            {
                ...
                mCommand.CommandText = "delete from facilitycorporatesubgroups where code='" + mCode.Trim() + "'";
                mCommand.ExecuteNonQuery();
