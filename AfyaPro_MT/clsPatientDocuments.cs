...
{
    public class clsPatientDocuments : MarshalByRefObject
    {
        #region declaration

        private static String pClassName = "AfyaPro_MT.clsPatientDocuments";
        ...
        public DataTable View(String mFilter, String mOrder, string mLanguageName, string mGridName)
        {
            ...
            try
            {
                string mCommandText = "select * from facilitypatientdocuments";
                ...
                DataTable mDataTable = new DataTable("facilitypatientdocuments");
        ...
        public AfyaPro_Types.clsResult Add(Int16 mGenerateCode, String mCode, String mDescription,
            int mPrintOrder, string mUserId)
        {
            ...
            bool mGranted = clsGlobal.GrantDeny_FunctionAccess(mCommand,
                AfyaPro_Types.clsSystemFunctions.FunctionKeys.genpatientdocumentssetup_add.ToString(), mUserId);
            if (mGranted == false)
            {
            ...
            if (mGenerateCode == 1)
            {
                ...
                mObjCode = objAutoCodes.Next_Code(
                    Convert.ToInt16(AfyaPro_Types.clsEnums.SystemGeneratedCodes.patientdocumentcode), "facilitypatientdocuments", "code");
            ...
            try
            {
                mCommand.CommandText = "select * from facilitypatientdocuments where code='"
                + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == true)
                {
                    mResult.Exe_Result = 0;
                    mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.GEN_PatientDocumentCodeIsInUse.ToString();
                    return mResult;
                }
            }
            ...
            try
            {
                ...
                //facilitypatientdocuments
                mCommand.CommandText = "insert into facilitypatientdocuments(code,description,printorder) "
                + "values('" + mCode.Trim() + "','" + mDescription.Trim() + "'," + mPrintOrder + ")";
                ...
                if (mGenerateCode == 1)
                {
                    ...
                    + Convert.ToInt16(AfyaPro_Types.clsEnums.SystemGeneratedCodes.patientdocumentcode);
                    mCommand.ExecuteNonQuery();
                }
        ...
        #region Edit
        public AfyaPro_Types.clsResult Edit(String mCode, String mDescription, int mPrintOrder, string mUserId)
        {
            ...
            #region check security for this function
            bool mGranted = clsGlobal.GrantDeny_FunctionAccess(mCommand,
                AfyaPro_Types.clsSystemFunctions.FunctionKeys.genpatientdocumentssetup_edit.ToString(), mUserId);
            if (mGranted == false)
            {
                mResult.Exe_Result = 0;
                mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.GRL_AccessDeniedToSystemFunction.ToString();
            ...
            try
            {
                mCommand.CommandText = "select * from facilitypatientdocuments where code='" + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == false)
                {
                    mResult.Exe_Result = 0;
                    mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.GEN_PatientDocumentCodeDoesNotExist.ToString();
                    return mResult;
                }
            }
            catch (OdbcException ex)
            ...
            try
            {
                ...
                mCommand.CommandText = "update facilitypatientdocuments set description = '"
                + mDescription.Trim() + "',printorder=" + mPrintOrder + " where code='" + mCode.Trim() + "'";
                mCommand.ExecuteNonQuery();
        ...
        public AfyaPro_Types.clsResult Delete(String mCode, string mUserId)
        {
            ...
            #region check security for this function
            bool mGranted = clsGlobal.GrantDeny_FunctionAccess(mCommand,
                AfyaPro_Types.clsSystemFunctions.FunctionKeys.genpatientdocumentssetup_delete.ToString(), mUserId);
            if (mGranted == false)
            {
                mResult.Exe_Result = 0;
                mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.GRL_AccessDeniedToSystemFunction.ToString();
            ...
            try
            {
                ...
                mCommand.CommandText = "delete from facilitypatientdocuments where code='" + mCode.Trim() + "'";
                mCommand.ExecuteNonQuery();
