...
{
    public class clsDXTIndicatorGroups : MarshalByRefObject
    {
        #region declaration

        private static String pClassName = "AfyaPro_MT.clsDXTIndicatorGroups";
        ...
        public DataTable View(String mFilter, String mOrder, string mLanguageName, string mGridName)
        {
            ...
            try
            {
                string mCommandText = "select * from dxtindicatorgroups";
                ...
                DataTable mDataTable = new DataTable("dxtindicatorgroups");
        ...
        public AfyaPro_Types.clsResult Add(Int16 mGenerateCode, string mCode, string mDescription, string mUserId)
        {
            ...
            bool mGranted = clsGlobal.GrantDeny_FunctionAccess(mCommand,
                AfyaPro_Types.clsSystemFunctions.FunctionKeys.dxtindicatorgroups_add.ToString(), mUserId);
            if (mGranted == false)
            {
            ...
            if (mGenerateCode == 1)
            {
                ...
                mObjCode = objAutoCodes.Next_Code(
                    Convert.ToInt16(AfyaPro_Types.clsEnums.SystemGeneratedCodes.indicatorgroups), "dxtindicatorgroups", "code");
            ...
            try
            {
                mCommand.CommandText = "select * from dxtindicatorgroups where code='"
                + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == true)
                {
                    mResult.Exe_Result = 0;
                    mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.DXT_DxIndicatorGroupCodeIsInUse.ToString();
                    return mResult;
                }
            }
            ...
            try
            {
                ...
                //execute statements
                mCommand.CommandText = "insert into dxtindicatorgroups(code,description) values('"
                ...
                if (mGenerateCode == 1)
                {
                    ...
                    + Convert.ToInt16(AfyaPro_Types.clsEnums.SystemGeneratedCodes.indicatorgroups);
                    mCommand.ExecuteNonQuery();
                }
        ...
        public AfyaPro_Types.clsResult Edit(String mCode, String mDescription, string mUserId)
        {
            ...
            #region check security for this function
            bool mGranted = clsGlobal.GrantDeny_FunctionAccess(mCommand,
                AfyaPro_Types.clsSystemFunctions.FunctionKeys.dxtindicatorgroups_edit.ToString(), mUserId);
            if (mGranted == false)
            {
                mResult.Exe_Result = 0;
                mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.GRL_AccessDeniedToSystemFunction.ToString();
            ...
            try
            {
                mCommand.CommandText = "select * from dxtindicatorgroups where code='" + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == false)
                {
                    mResult.Exe_Result = 0;
                    mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.DXT_DxIndicatorGroupCodeDoesNotExist.ToString();
                    return mResult;
                }
            }
            catch (OdbcException ex)
            ...
            try
            {
                ...
                mCommand.CommandText = "update dxtindicatorgroups set description = '"
        ...
        public AfyaPro_Types.clsResult Delete(String mCode, string mUserId)
        {
            ...
            #region check security for this function
            bool mGranted = clsGlobal.GrantDeny_FunctionAccess(mCommand,
                AfyaPro_Types.clsSystemFunctions.FunctionKeys.dxtindicatorgroups_delete.ToString(), mUserId);
            if (mGranted == false)
            {
                mResult.Exe_Result = 0;
                mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.GRL_AccessDeniedToSystemFunction.ToString();
            ...
            #region check if group is in use indicators
            try
            {
                mCommand.CommandText = "select * from dxtindicators where groupcode='" + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == true)
                {
                    mResult.Exe_Result = 0;
            ...
            try
            {
                ...
                mCommand.CommandText = "delete from dxtindicatorgroups where code='" + mCode.Trim() + "'";
                mCommand.ExecuteNonQuery();
