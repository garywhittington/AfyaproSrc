...
{
    public class clsSomSuppliers : MarshalByRefObject
    {
        #region declaration

        private static String pClassName = "AfyaPro_MT.clsSomSuppliers";
        ...
        public DataTable View(String mFilter, String mOrder, string mLanguageName, string mGridName)
        {
            ...
            try
            {
                string mCommandText = "select * from som_suppliers";
                ...
                DataTable mDataTable = new DataTable("som_suppliers");
        ...
        public AfyaPro_Types.clsResult Add(Int16 mGenerateCode, String mCode, String mDescription,
            string mPhone, string mAddress, string mFax, string mEmail, string mWebsite, string mUserId)
        {
            ...
            bool mGranted = clsGlobal.GrantDeny_FunctionAccess(mCommand,
                AfyaPro_Types.clsSystemFunctions.FunctionKeys.ivssourcesofstock_add.ToString(), mUserId);
            if (mGranted == false)
            {
            ...
            if (mGenerateCode == 1)
            {
                ...
                mObjCode = objAutoCodes.Next_Code(
                    Convert.ToInt16(AfyaPro_Types.clsEnums.SystemGeneratedCodes.suppliercode), "som_suppliers", "code");
            ...
            try
            {
                ...
                {
                    mResult.Exe_Result = 0;
                    mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.IVS_SupplierCodeIsInUse.ToString();
                    return mResult;
                }
            }
            ...
            #region supplier code should not be the same as store code
            try
            {
                ...
                {
                    mResult.Exe_Result = 0;
                    mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.IVS_SupplierCodeSameAsStoreCode.ToString();
                    return mResult;
                }
            }
            catch (OdbcException ex)
            ...
            try
            {
                ...
                //som_suppliers
                mCommand.CommandText = "insert into som_suppliers(code,description,phone,address,"
                + "fax,email,website) values('" + mCode.Trim() + "','" + mDescription.Trim() 
                + "','" + mPhone + "','" + mAddress + "','" + mFax + "','" + mEmail + "','" 
                + mWebsite + "')";
            ...
            string mPhone, string mAddress, string mFax, string mEmail, string mWebsite, string mUserId)
        {
            ...
            #region check security for this function
            bool mGranted = clsGlobal.GrantDeny_FunctionAccess(mCommand,
                AfyaPro_Types.clsSystemFunctions.FunctionKeys.ivssourcesofstock_edit.ToString(), mUserId);
            if (mGranted == false)
            {
                mResult.Exe_Result = 0;
                mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.GRL_AccessDeniedToSystemFunction.ToString();
            ...
            try
            {
                mCommand.CommandText = "select * from som_suppliers where code='" + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
                if (mDataReader.Read() == false)
                {
                    mResult.Exe_Result = 0;
                    mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.IVS_SupplierCodeDoesNotExist.ToString();
                    return mResult;
                }
            }
            catch (OdbcException ex)
            ...
            try
            {
                ...
                //som_suppliers
                mCommand.CommandText = "update som_suppliers set description = '"
                + mDescription.Trim() + "',address='" + mAddress + "',phone='" + mPhone + "',fax='" + mFax
                + "',email='" + mEmail + "',website='" + mWebsite + "' where code='" + mCode.Trim() + "'";
                mCommand.ExecuteNonQuery();
        ...
        public AfyaPro_Types.clsResult Delete(String mCode, string mUserId)
        {
            ...
            #region check security for this function
            bool mGranted = clsGlobal.GrantDeny_FunctionAccess(mCommand,
                AfyaPro_Types.clsSystemFunctions.FunctionKeys.ivssourcesofstock_delete.ToString(), mUserId);
            if (mGranted == false)
            {
                mResult.Exe_Result = 0;
                mResult.Exe_Message = AfyaPro_Types.clsSystemMessages.MessageIds.GRL_AccessDeniedToSystemFunction.ToString();
            ...
            try
            {
                ...
                mCommand.CommandText = "delete from som_suppliers where code='" + mCode.Trim() + "'";
                mCommand.ExecuteNonQuery();
