...
{
    public class clsDiagnosesGroups : MarshalByRefObject
    {
        #region declaration

        private static String pClassName = "AfyaPro_MT.clsDiagnosesGroups";
        ...
        public DataTable View(String mFilter, String mOrder, string mLanguageName, string mGridName)
        {
            ...
            try
            {
                string mCommandText = "select * from dxtdiagnosesgroups";
                ...
                DataTable mDataTable = new DataTable("dxtdiagnosesgroups");
        ...
        public AfyaPro_Types.clsResult Add(String mCode, String mDescription, string mUserId)
        {
            ...
            try
            {
                mCommand.CommandText = "select * from dxtdiagnosesgroups where code='"
                + mCode.Trim() + "'";
        ...
        public AfyaPro_Types.clsResult Edit(String mCode, String mDescription, string mUserId)
        {
            ...
            try
            {
                mCommand.CommandText = "select * from dxtdiagnosesgroups where code='" + mCode.Trim() + "'";
                mDataReader = mCommand.ExecuteReader();
            ...
            try
            {
                ...
                mCommand.CommandText = "update dxtdiagnosesgroups set description = '"
        ...
        public AfyaPro_Types.clsResult Delete(String mCode, string mUserId)
        {
            ...
            try
            {
                ...
                mCommand.CommandText = "delete from dxtdiagnosesgroups where code='" + mCode.Trim() + "'";
                mCommand.ExecuteNonQuery();
