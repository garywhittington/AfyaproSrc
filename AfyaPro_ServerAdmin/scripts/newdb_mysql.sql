...
CREATE TABLE ctc_patients (
	...
	firsthivtestresult INT(11) DEFAULT '0',
	secondhivtestdate DATETIME DEFAULT NULL,
	secondhivtestresult INT(11) DEFAULT '0',
	...
	artstartclinicalstage INT(11) DEFAULT '0',
	artstartfunctionalstatuscode VARCHAR(50) DEFAULT '',
	artstartweight DOUBLE(11,2) DEFAULT '0.00',
	artstartcd4 DOUBLE(11,2) DEFAULT '0.00',
...
CREATE TABLE ctc_artvisits (
	...
	patientlength DOUBLE(11,2) DEFAULT '0.00',
	...
	cotrim INT(11) DEFAULT '0',
	diflucan INT(11) DEFAULT '0',
	...
	cd4count DOUBLE(11,2) DEFAULT '0.00',
	...
	referredtodescription VARCHAR(50) DEFAULT '',
...
CREATE TABLE ctc_patientaidsillness (
	autocode INT(11) NOT NULL AUTO_INCREMENT,
	visitcode INT(11) NOT NULL DEFAULT '0',
	patientcode VARCHAR(50) DEFAULT '',
...
CREATE TABLE ctc_patientabnormallabresults (
	...
	visitcode INT(11) NOT NULL DEFAULT '0',
	patientcode VARCHAR(50) DEFAULT '',
	labtesttypecode VARCHAR(50) DEFAULT '',
	results VARCHAR(255) DEFAULT '',
	resultfigure VARCHAR(255) DEFAULT '',
