namespace AfyaPro_NextGen
{
    partial class frmCTCARTVisits
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.grdCTCARTVisits = new DevExpress.XtraGrid.GridControl();
            this.viewCTCARTVisits = new DevExpress.XtraGrid.Views.Grid.GridView();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.grdCTCARTVisits)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.viewCTCARTVisits)).BeginInit();
            ...
            this.layoutControl1.Controls.Add(this.grdCTCARTVisits);
            ...
            // grdCTCARTVisits
            // 
            this.grdCTCARTVisits.Location = new System.Drawing.Point(12, 12);
            this.grdCTCARTVisits.MainView = this.viewCTCARTVisits;
            this.grdCTCARTVisits.Name = "grdCTCARTVisits";
            this.grdCTCARTVisits.Size = new System.Drawing.Size(855, 472);
            this.grdCTCARTVisits.TabIndex = 14;
            this.grdCTCARTVisits.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.viewCTCARTVisits});
            this.grdCTCARTVisits.Visible = false;
            // 
            // viewCTCARTVisits
            // 
            this.viewCTCARTVisits.GridControl = this.grdCTCARTVisits;
            this.viewCTCARTVisits.Name = "viewCTCARTVisits";
            this.viewCTCARTVisits.OptionsBehavior.Editable = false;
            this.viewCTCARTVisits.OptionsView.ColumnAutoWidth = false;
            this.viewCTCARTVisits.OptionsView.ShowGroupPanel = false;
            // 
            // cmdDelete
            // 
            ...
            // txbCTCHIVTests
            // 
            this.txbCTCHIVTests.Control = this.grdCTCARTVisits;
            ...
            this.Name = "frmCTCARTVisits";
            this.ShowIcon = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "Adult ART Formulations History";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.frmCTCARTVisits_FormClosing);
            this.Load += new System.EventHandler(this.frmCTCARTVisits_Load);
            this.Shown += new System.EventHandler(this.frmCTCARTVisits_Shown);
            ((System.ComponentModel.ISupportInitialize)(this.layoutControl1)).EndInit();
            this.layoutControl1.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)(this.grdCTCARTVisits)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.viewCTCARTVisits)).EndInit();
        ...
        internal DevExpress.XtraGrid.GridControl grdCTCARTVisits;
        private DevExpress.XtraGrid.Views.Grid.GridView viewCTCARTVisits;
