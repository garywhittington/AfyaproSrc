...
{
    public partial class frmSearchIndicator : DevExpress.XtraEditors.XtraForm
    {
        #region declaration

        private AfyaPro_MT.clsDXTIndicatorGroups pMdtDXTIndicatorGroups;
        ...
        #region frmSearchIndicator
        public frmSearchIndicator(object mSourceObject)
        {
            InitializeComponent();

            pType = this.GetType();
            pClassName = pType.FullName;
            string mFunctionName = "frmSearchIndicator";
            ...
            try
            {
                ...
                pMdtDXTIndicatorGroups = (AfyaPro_MT.clsDXTIndicatorGroups)Activator.GetObject(
                    typeof(AfyaPro_MT.clsDXTIndicatorGroups),
                    Program.gMiddleTier + "clsDXTIndicatorGroups");
        ...
        #region frmSearchIndicator_Load
        private void frmSearchIndicator_Load(object sender, EventArgs e)
        {
            string mFunctionName = "frmSearchIndicator_Load";
        ...
        #region frmSearchIndicator_Activated
        private void frmSearchIndicator_Activated(object sender, EventArgs e)
        {
        ...
        #region frmSearchIndicator_FormClosing
        private void frmSearchIndicator_FormClosing(object sender, FormClosingEventArgs e)
        {
            string mFunctionName = "frmSearchIndicator_FormClosing";
            ...
            try
            {
                ...
                Program.Save_GridLayout(grdSearch, "grdSearchIndicator");

                Program.gMdtUserActions.Save_IndicatorSearching(
        ...
        void Load_DefaultOptions()
        {
            ...
            try
            {
                foreach (DataRow mDataRow in pDtSearchFields.Rows)
                {
                    if (Program.gDtUserActions.Rows.Count > 0)
                    {
                        if (mDataRow["fieldname"].ToString().Trim().ToLower() ==
                            Program.gDtUserActions.Rows[0]["searchindicatorfieldname"].ToString().Trim().ToLower())
                        {
                ...
                if (Program.gDtUserActions.Rows.Count > 0)
                {
                    radOptions.SelectedIndex = Convert.ToInt16(Program.gDtUserActions.Rows[0]["searchindicatorsoption"]);
                    chkSearchWhileTyping.Checked = Convert.ToBoolean(Program.gDtUserActions.Rows[0]["searchindicatorswhiletyping"]);
                }
        ...
        private void Fill_LookupData()
        {
            ...
            try
            {
                ...
                DataTable mDtSearchFields = pMdtSearchEngine.View_SearchFields("dxtindicators", Program.gLanguageName, "grdGENSearchEngine");
                ...
                DataTable mDtCustomerGroups = pMdtDXTIndicatorGroups.View("", "code", Program.gLanguageName, "grdDXTIndicatorGroups");
        ...
        private void Search()
        {
            ...
            try
            {
                ...
                pDtSearchResults = pMdtDXTIndicators.View(mRowFilter, mFieldName, Program.gLanguageName, "grdSearchIndicator");
                grdSearch.DataSource = pDtSearchResults;

                //restore current document layout
                Program.Restore_GridLayout(grdSearch, "grdSearchIndicator");
