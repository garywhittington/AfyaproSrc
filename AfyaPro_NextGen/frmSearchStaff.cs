...
{
    public partial class frmSearchStaff : DevExpress.XtraEditors.XtraForm
    {
        #region declaration
        ...
        public frmSearchStaff(object mSourceObject)
        {
            InitializeComponent();
        ...
        #region frmSearchStaff_Load
        private void frmSearchStaff_Load(object sender, EventArgs e)
        {
            string mFunctionName = "frmSearchStaff_Load";
        ...
        private void frmSearchStaff_FormClosing(object sender, FormClosingEventArgs e)
        {
            string mFunctionName = "frmSearchStaff_FormClosing";
            ...
            try
            {
                ...
                Program.Save_GridLayout(grdSearch, "grdSearchStaff");
        ...
        private void Search()
        {
            ...
            try
            {
                ...
                pDtSearchResults = pMdtSearchEngine.Search_Patient(mRowFilter, mFieldName, Program.gLanguageName, "grdPatientDetails");
