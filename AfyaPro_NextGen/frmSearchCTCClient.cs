...
{
    public partial class frmSearchCTCClient : DevExpress.XtraEditors.XtraForm
    {
        #region declaration
        ...
        #region frmSearchCTCClient
        public frmSearchCTCClient(object mSourceObject)
        {
            InitializeComponent();

            pType = this.GetType();
            pClassName = pType.FullName;
            string mFunctionName = "frmSearchCTCClient";
        ...
        #region frmSearchCTCClient_Load
        private void frmSearchCTCClient_Load(object sender, EventArgs e)
        {
            string mFunctionName = "frmSearchCTCClient_Load";
        ...
        #region frmSearchCTCClient_FormClosing
        private void frmSearchCTCClient_FormClosing(object sender, FormClosingEventArgs e)
        {
            string mFunctionName = "frmSearchCTCClient_FormClosing";
            ...
            try
            {
                ...
                Program.Save_GridLayout(grdSearch, "grdSearchCTCClient");
        ...
        private void Fill_LookupData()
        {
            ...
            try
            {
                ...
                DataTable mDtSearchFields = pMdtSearchEngine.View_SearchFields("ctc_patients", Program.gLanguageName, "grdGENSearchEngine");
        ...
        private void Search()
        {
            ...
            try
            {
                ...
                if (cboSearchField.ItemIndex != -1)
                {
                    ...
                    if (mFieldName.Trim().ToLower().StartsWith("ctc"))
                    {
                        mFieldName = "b." + mFieldName.Substring(3);
                    }
                }
                ...
                {
                    mRowFilter = mRowFilter + " AND fromctc=1";
                }

                DataTable mDtSearchResults = pMdtSearchEngine.Get_CTCClients(mRowFilter, "");
                grdSearch.DataSource = mDtSearchResults;

                //restore current document layout
                Program.Restore_GridLayout(grdSearch, "grdSearchCTCClient");
