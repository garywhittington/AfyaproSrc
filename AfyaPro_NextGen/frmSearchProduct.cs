...
namespace AfyaPro_NextGen
{
    public partial class frmSearchProduct : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmSearchProduct()
        {
            ...
            string mFunctionName = "frmSearchProduct";
        ...
        #region frmSearchProduct_Load
        private void frmSearchProduct_Load(object sender, EventArgs e)
        {
            string mFunctionName = "frmSearchProduct_Load";
        ...
        #region frmSearchProduct_Activated
        private void frmSearchProduct_Activated(object sender, EventArgs e)
        {
        ...
        #region frmSearchProduct_FormClosing
        private void frmSearchProduct_FormClosing(object sender, FormClosingEventArgs e)
        {
            string mFunctionName = "frmSearchProduct_FormClosing";
            ...
            try
            {
                ...
                Program.Save_GridLayout(grdSearch, "grdSearchProduct");
        ...
        private void Search()
        {
            ...
            try
            {
                ...
                pDtSearchResults = pMdtSomProducts.View(mRowFilter, mFieldName, Program.gLanguageName, "grdIVSProducts");
                grdSearch.DataSource = pDtSearchResults;

                //restore current document layout
                Program.Restore_GridLayout(grdSearch, "grdSearchProduct");
