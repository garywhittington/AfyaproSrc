...
{
    partial class frmCTCARTTVisits
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.grdCTCARTTVisits = new DevExpress.XtraGrid.GridControl();
            this.viewCTCARTTVisits = new DevExpress.XtraGrid.Views.Grid.GridView();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.grdCTCARTTVisits)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.viewCTCARTTVisits)).BeginInit();
            ...
            this.layoutControl1.Controls.Add(this.grdCTCARTTVisits);
            ...
            // grdCTCARTTVisits
            // 
            this.grdCTCARTTVisits.Location = new System.Drawing.Point(12, 12);
            this.grdCTCARTTVisits.MainView = this.viewCTCARTTVisits;
            this.grdCTCARTTVisits.Name = "grdCTCARTTVisits";
            this.grdCTCARTTVisits.Size = new System.Drawing.Size(855, 472);
            this.grdCTCARTTVisits.TabIndex = 14;
            this.grdCTCARTTVisits.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.viewCTCARTTVisits});
            this.grdCTCARTTVisits.Visible = false;
            // 
            // viewCTCARTTVisits
            // 
            this.viewCTCARTTVisits.GridControl = this.grdCTCARTTVisits;
            this.viewCTCARTTVisits.Name = "viewCTCARTTVisits";
            this.viewCTCARTTVisits.OptionsBehavior.Editable = false;
            this.viewCTCARTTVisits.OptionsView.ColumnAutoWidth = false;
            this.viewCTCARTTVisits.OptionsView.ShowGroupPanel = false;
            // 
            // cmdDelete
            // 
            ...
            // txbCTCHIVTests
            // 
            this.txbCTCHIVTests.Control = this.grdCTCARTTVisits;
            ...
            this.Name = "frmCTCARTTVisits";
            this.ShowIcon = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
            this.Text = "CTC 2 Visit Details";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.frmCTCARTTVisits_FormClosing);
            this.Load += new System.EventHandler(this.frmCTCARTTVisits_Load);
            this.Shown += new System.EventHandler(this.frmCTCARTTVisits_Shown);
            ((System.ComponentModel.ISupportInitialize)(this.layoutControl1)).EndInit();
            this.layoutControl1.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)(this.grdCTCARTTVisits)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.viewCTCARTTVisits)).EndInit();
        ...
        internal DevExpress.XtraGrid.GridControl grdCTCARTTVisits;
        private DevExpress.XtraGrid.Views.Grid.GridView viewCTCARTTVisits;
